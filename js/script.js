...
// 🌍 СЛОВАРЬ ПЕРЕВОДОВ (С душой и хинкали)
const translations = {
    ru: {
        ...
        about_title: "Хватит играть в рулетку с автовокзалом",
        about_text: "SharaGo — это когда ты точно знаешь, что уедешь. Сидя, а не стоя на одной ноге в проходе.",
        about_list_1: "Твое место — твое",
        about_desc_1: "Никто не займет его сумкой или чемоданом.",
        about_list_2: "Честная цена",
        about_desc_2: "Как для местных. Никаких наценок для туристов.",
        about_list_3: "Диспетчер — человек",
        about_desc_3: "Не робот. Позвонит, подскажет, встретит.",
        service_tag: "🚀 Сервис №1 в Грузии",
        stations_title: "Автовокзалы Тбилиси",
        stations_subtitle: "Нажмите, чтобы увидеть карты всех вокзалов",
        ...
        // Футер
        footer_desc: "Первый в Грузии сервис бронирования, который реально работает. Сделано с любовью, хинкали и хачапури ❤️ 🧀",
    ...
    en: {
        ...
        about_text: "SharaGo means you know for sure you'll leave. Sitting, not standing on one leg.",
        about_list_1: "Your seat is yours",
        about_desc_1: "No one will take it with a bag or suitcase.",
        about_list_2: "Fair price",
        about_desc_2: "Same as for locals. No tourist markups.",
        about_list_3: "Dispatcher is human",
        about_desc_3: "Not a robot. Will call, guide, and meet you.",
        service_tag: "🚀 Service #1 in Georgia",
        stations_title: "Tbilisi Bus Stations",
        stations_subtitle: "Click to see maps of all stations",
    ...
    ka: {
        ...
        about_desc_1: "თქვენი ადგილი შენახულია.",
        about_list_2: "ფიქსირებული ფასი",
        about_desc_2: "როგორც ადგილობრივებისთვის.",
        about_list_3: "დისპეტჩერი ხაზზეა",
        about_desc_3: "დაგირეკავთ და დაგეხმარებათ.",
...
// 🔥 СЛОВАРЬ ДНЕЙ НЕДЕЛИ (чтобы переводилось красиво)
const daysMap = {
...
function initDateTabs() {
    ...
    for (let i = 0; i < 7; i++) {
        ...
        // Используем наш словарь для дней недели
        let label = daysMap[currentLang][date.getDay()];

        const isActive = i === selectedDateIndex;
        // Активный таб теперь с синей заливкой и белым текстом
